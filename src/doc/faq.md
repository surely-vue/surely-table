...
举个例子：如果你的域名是 `admin.baidu.com`，同时您购买的的是子域名授权，那么授权码不可以用在除 `admin.baidu.com` 之外的站点上，相反，如果您购买的是通配符域名授权，那么你的授权码可以使用在 `baidu.com` 下的任何域名下。

如果您明确知道你的应用仅在特定域名下运行，你可以选择子域名授权，而且我们支持三个月内的补差价升级通配符域名。
...
您会有很多选择，开源 Ant Design Vue 同样也可以满足您；
